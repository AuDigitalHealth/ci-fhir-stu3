...
This implementation guide is the basis for the corresponding [Personal Health Records CDA implementation guide [DH2019k]](#DH2020r). The profiles referenced by this FHIR implementation guide are the 'models' that are mapped into CDA.
...
|[<a name="DH2020r">DH2019j</a>]| Australian Digital Health Agency, Not yet published, Personal Health Records CDA implementation guide, Version 1.0.|
