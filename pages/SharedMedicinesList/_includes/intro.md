...
<table class="list" width="100%" cellspacing="6">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>Release at approved for external trial use. Implemented in FHIR Release 3 (STU).<br/>Release at approved for external trial use. Implemented in FHIR Release 3 (STU).
                This version includes changes to relax MedicationStatement.dosage cardinality to support recording information about ceased medicines items in PSML, addition of Dose Administration Aid Medicines Indicator in the List profile to support recording information that that a PSML includes items packed in a dose administration aid, and improvements to the Composition invariants.</td>
        </tr>
    </tbody>
</table> 
