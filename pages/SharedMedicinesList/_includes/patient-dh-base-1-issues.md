...
<tbody>
  ...
  <tr>
    ...
    <tr>
        <td>Patient.name</td>
        <td>The Snapshot table presents data type profile (HumanNameBase) definition "A human's name with the ability to identify parts and usage." rather than core element (Patient.name) definition "A name associated with the individual.".</td>
