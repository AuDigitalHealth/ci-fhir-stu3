...
This implementation guide is an HL7<sup>TM</sup> FHIR<sup>&reg;</sup> specification to represent prescription and / or dispense lists, including Prescription List (PL), Dispense List (DL) and Prescription and Dispense List (PDL).
...
The primary aim of this implementation guide is to support implementing prescription and / or dispense lists in [FHIR Release 3 (STU) [HL7FHIR3]](#HL7FHIR3). The resulting FHIR can be used for the electronic exchange of prescription and / or dispense lists information between healthcare providers.
...
This implementation guide is the basis for the corresponding [Prescription and Dispense Lists CDA-IG [DH2020a]](#DH2020a). The profiles referenced by this FHIR implementation guide are the 'models' that are mapped into CDA.
...
For implementers interested in representing prescription and / or dispense records as a list, and not a document, the starting point is the [List of Prescription and or Dispense Records](StructureDefinition-list-pdl-1.html) profile, which references the additional profiles necessary to assert [conformance](conformance.html).

For implementers interested in representing prescription and / or dispense records as a list with provenance information, the starting point is the [Provenance for the Generation of a List](StructureDefinition-provenance-list-gen-1.html) profile, which references the additional profiles necessary to assert [conformance](conformance.html).

For implementers interested in a list of prescription and / or dispense records as a document, the starting point is the [Prescription and or Dispense List](StructureDefinition-composition-pdl-1.html) profile, which references the additional profiles necessary to assert [conformance](conformance.html).
...
<tbody>
  <tr bgcolor="#DCDCDC">
    ...
    <tr>
        <td>PDL FHIR implementation guide roadmap</td>
        <td>The profiles that form part of this implementation guide, and this implementation guide itself, are incomplete. This implementation guide may transition to FHIR Release 4, in collaboration with HL7 Australia.
		<br/><br/>
...
|[<a name="DH2020a">DH2020a</a>]| Australian Digital Health Agency, Not yet published, Prescription and Dispense Lists CDA Implementation Guide, Version 1.0.0|

|[<a name="HL7AUF3B2">HL7AUF3B2</a>]| HL7 Australia, Australian Base Implementation Guide (AU Base 1.1), (Continuous Integration), accessed 16 March 2020|
