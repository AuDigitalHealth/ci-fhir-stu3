...
The primary aim of this implementation guide is to support implementing SHS in [FHIR Release 3 (STU) [HL7FHIR3]](#HL7FHIR3). The resulting FHIR can be used for the electronic exchange of SHS information between healthcare providers.
...
This implementation guide is the basis for the corresponding [Shared Health Summary CDA implementation guide [DH2020c]](#DH2020c). The profiles referenced by this FHIR implementation guide are the 'models' that are mapped into CDA.
...
The starting point for the profiles included in this implementation guide is the [{{site.data.fhir.igName}}](StructureDefinition-composition-shs-1.html) profile, which references the additional profiles necessary to assert [conformance](conformance.html).
...
<tbody>
  <tr bgcolor="#DCDCDC">
    ...
    <tr>
        <td>SHS FHIR implementation guide roadmap</td>
...
|[<a name="DH2020c">DH2020c</a>]| Australian Digital Health Agency, Not yet published, Shared Health Summary CDA Implementation Guide, Version 2.0.0|

|[<a name="HL7AUF3B2">HL7AUF3B2</a>]| HL7 Australia, Australian Base Implementation Guide (AU Base 1.1), (Continuous Integration), accessed 09 March 2020|
