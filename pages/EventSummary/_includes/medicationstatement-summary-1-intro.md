...
For the overarching usage scenarios in this implementation guide it is expected that a sending system will set the value of taken as per the guidance in the Comments field of the [MedicationStatement](StructureDefinition-medicationstatement-summary-1-definitions.html#MedicationStatement) element.
