                                ...
                                <div id="tabs-1">
                                    <table width="100%">
                                        ...
                                        <tr class="frm-contents" height="80">
                                            ...
                                            <td class="frm-set">
                                                <ul>
                                                    <li><a href="StructureDefinition-composition-es-1.html">Composition (Event Summary)</a></li>
                                                </ul>
                                            </td>
                                            <td class="frm-null"/>
                                        </tr>
                                        ...
                                        <tr class="frm-contents">
                                            ...
                                            <td class="frm-set">
                                                <ul class="frm-set">
                                                    ...
                                                    <li><a href="StructureDefinition-immunization-summary-1.html">Immunization (Summary Statement of Vaccine)</a></li>
                                                </ul>
                                            </td>
                                            <td class="frm-null"/>
                                            <td class="frm-null"/>
