...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Provenance/f:meta">
      <sch:assert test="Provenance.meta">One meta.profile shall be 'http://ns.electronichealth.net.au/ci/fhir/3.0/StructureDefinition/provenance-list-gen-1'</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
