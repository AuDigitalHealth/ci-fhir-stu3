...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile AUBaseEncounter
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Encounter/f:hospitalization">
      <sch:assert test="count(f:extension[@url = 'http://hl7.org.au/fhir/StructureDefinition/encounter-origin-organisation']) &lt;= 1">extension with URL = 'http://hl7.org.au/fhir/StructureDefinition/encounter-origin-organisation': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://hl7.org.au/fhir/StructureDefinition/encounter-destination-organisation']) &lt;= 1">extension with URL = 'http://hl7.org.au/fhir/StructureDefinition/encounter-destination-organisation': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
