...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Encounter">
      <sch:assert test="count(f:extension[@url = 'http://hl7.org.au/fhir/StructureDefinition/encounter-description']) &gt;= 1">extension with URL = 'http://hl7.org.au/fhir/StructureDefinition/encounter-description': minimum cardinality of 'extension' is 1</sch:assert>
